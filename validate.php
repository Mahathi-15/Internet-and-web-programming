...
if(isset($_POST['login'])){
    ...
    else
    {
        ...
        if($count==1)
        {
                    ...
                    else if($row['email_address'] == 'dhanush123@gmail.com' && $row['password'] == '7052ba451d2a45626d6170d5c1b4f712'){
                        $_SESSION['username']=$username;
                        $_SESSION['email_address'] = $email_address;
...
if(isset($_POST['forgot'])){
    ...
    if(mysqli_num_rows($result)==0){
        ...
        //phpMailer isnt working as gmail as recently updated two step verification, we have to use zapier which basically connects two apllication
