<?php
	...
	$phpmailer->Port = 2525;
	$phpmailer->Username = 'b1fe53c41246fe';
	$phpmailer->Password = '5a7bfe85c8e392';
	//$mail->Port = 587;                                    // TCP port to connect to
	$to=$_SESSION['email_address'];
	$phpmailer->setFrom('your email address', 'Musical World');
	$phpmailer->addAddress($to);     // Add a recipient

	$phpmailer->isHTML(true);                                  // Set email format to HTML

	$phpmailer->Subject = 'Account Confirmation Message';
	$phpmailer->Body = "	 Thank You ".$_SESSION['username']. " for signing up!
